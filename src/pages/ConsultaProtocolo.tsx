  ...
  return (
    <div className="mx-auto max-w-5xl py-2 sm:py-8">
      <div className="max-w-2xl">
        ...
        <p className="mt-3 text-sm leading-relaxed text-slate-600 sm:text-base">Digite o protocolo recebido no envio para consultar o status e o histórico público do caso.</p>
        <div className="mt-4 flex gap-3 rounded-2xl border border-[#cfeee2] bg-[#eaf8f3] p-4 text-xs leading-relaxed text-[#285e59] sm:text-sm"><ShieldCheck className="mt-0.5 h-4 w-4 shrink-0 text-[#0f766e]" /><p>A consulta pública mostra apenas protocolo, município, categoria, status, datas e histórico de status. Descrição, contato, foto e observações internas não são exibidos aqui.</p></div>
      </div>
        ...
        <div className="mt-7 grid gap-5 lg:grid-cols-[1.4fr_0.6fr]">
          <section className="surface-card p-5 sm:p-7">
            ...
            <div className="mt-6 grid gap-3 sm:grid-cols-3">
              <div className="rounded-2xl bg-[#f6f9fb] p-4"><MapPin className="mb-2 h-4 w-4 text-[#1b5f8f]" /><span className="block text-[10px] font-extrabold uppercase tracking-[0.14em] text-slate-400">Município</span><span className="mt-1 block text-sm font-semibold text-slate-700">{resultado.demanda.municipio}</span></div>
              ...
              <div className="rounded-2xl bg-[#f6f9fb] p-4"><Clock className="mb-2 h-4 w-4 text-[#1b5f8f]" /><span className="block text-[10px] font-extrabold uppercase tracking-[0.14em] text-slate-400">Registrado</span><span className="mt-1 block text-sm font-semibold text-slate-700">{formatDate(resultado.demanda.created_at)}</span></div>
            </div>
          </section>

          <aside className="surface-card p-5 sm:p-6">
            <h3 className="text-lg font-extrabold text-[#0b1f33]">Histórico público</h3>
            <p className="mt-1 text-xs leading-relaxed text-slate-500">As mudanças de status ficam registradas em ordem cronológica.</p>
