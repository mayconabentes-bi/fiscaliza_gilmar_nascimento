...
expect(helper.includes('bairro: string') && helper.includes('categoria: string'), 'Rascunho deve limitar-se a bairro/localidade e categoria.');
...
expect(form.includes('salve somente bairro/localidade e categoria por até 6 horas'), 'UI deve explicar limite e validade do rascunho.');
...
console.log('Safe draft contract OK: opt-in explícito, TTL curto, somente bairro/categoria e sem PII/texto livre/foto/telemetria nova.');
